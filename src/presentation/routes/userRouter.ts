...
// router.get("/user-management", passport.authenticate('jwt', { session: false }), adminverifyToken, controller.getAllUsers.bind(controller));
router.get("/user-management",controller.getAllUsers.bind(controller));
router.put("/isBlocked/:userId", controller.isBlocked.bind(controller));
